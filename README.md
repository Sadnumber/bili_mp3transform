# B站视频缓存后批量转化成MP3音频和MP4视频的自动化脚本工具。
...
## 六、杂谈
- 原项目只做了音频的转换，是因为作者喜欢的几首lofi音乐在网易云和QQ都没找到，只能出此下策保存到歌单。
- 视频流文件的文件名末尾有多种编号，如30016(360p)、30032(480p)、30064(720p)、30080(1080p)等，应该是根据编码和分辨率生成的，作者不好确认所有的型号，因此超出已知编号的直接用比大小选择文件夹中更大的m4s作为视频流了，一般来说视频总比音频大吧（大概）。
